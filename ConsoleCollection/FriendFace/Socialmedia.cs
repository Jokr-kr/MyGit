...
using static ConsoleCollection.FriendFace.Methods;

namespace ConsoleCollection.FriendFace;
internal static class MainSite
{
    ...
    public static void Start()
    {
        ...
        while (menu)
        {
            ...
            if (ans >= 0 || ans <= 5)
            {
                //switch expression doesnt seem to work with methods,
                //using switch case instead. getting back to expression later //
                //todo:Learn more about switch expression
