...
using static ConsoleCollection.FriendFace.MainSite;

namespace ConsoleCollection.FriendFace
{
    internal static class Methods
    {
        //-----------------start of program -- fast "user creation"----------//
        ...
        //------making some Users so i have something to work with-------//
        ...
        //---showing all the generated Users of the program
